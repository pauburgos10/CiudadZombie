...
/* Constructor para el parametro rangoMov que recibe el Enemigo en su contructor*/
var RangoMov = function(desdeX,hastaX,desdeY,hastaY){
  this.desdeX = desdeX;
  this.desdeY = desdeY;
  this.hastaX = hastaX;
  this.hastaY = hastaY;
...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/bache.png', 120, 270, 30, 30, 2),
    new Obstaculo('imagenes/valla_horizontal.png', 70, 430, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 300, 390, 30, 15, 3),
    new Obstaculo('imagenes/valla_horizontal.png', 470, 255, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 390, 80, 30, 30, 2),  
    new Obstaculo('imagenes/valla_horizontal.png', 770, 420, 30, 30, 1),      
    new Obstaculo('imagenes/valla_horizontal.png', 820, 200, 30, 30, 1)    
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 890, 450, 10, 10, 2, new RangoMov(450,890,400,450)),
    new ZombieCaminante('imagenes/zombie2.png', 550, 250, 10, 10, 2, new RangoMov(250,550,230,250)),
    new ZombieCaminante('imagenes/zombie3.png', 200, 350, 10, 10, 2, new RangoMov(70,350,350,450)),
    new ZombieCaminante('imagenes/zombie4.png', 740, 100, 10, 10, 2, new RangoMov(600,740,20,150)),
    new ZombieCaminante('imagenes/zombie3.png', 610, 320, 10, 10, 2, new RangoMov(450,610,310,400)),
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 5, new RangoMov(0,850,322,322),'h'),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 5, new RangoMov(644,644,0,460),'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 3, new RangoMov(678,678,0,460),'v')
  ]
...
Juego.iniciarRecursos = function() {
  Resources.load([
    ...
    'imagenes/finish1.png',
    'imagenes/finish2.png',
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y) && direccion != 'invalid') {
    /* Aca tiene que estar la logica para mover al jugador invocando alguno
    de sus metodos  */
    /* COMPLETAR */
    this.jugador.avanzar(movX, movY,direccion);    
  } 
};
...
Juego.dibujarFondo = function() {  
  ...
  // Si se gano el juego hay que mostrar el mensaje de ganoJuego de fondo
    ...
    document.getElementById('reiniciar').style.visibility = 'visible';
    this.mjeInicioJuego = 4;
  } else if (this.mjeInicioJuego == 1) {
    Dibujante.dibujarImagen('imagenes/Mensaje1.png', 0, 5, this.anchoCanvas, this.altoCanvas);
    document.getElementById('siguiente').addEventListener('click', function(){Juego.mjeInicioJuego = 2;});
  } else if (this.mjeInicioJuego == 2) {
    ...
    document.getElementById('siguiente').addEventListener('click', function(e){
      Juego.mjeInicioJuego = 3;
      e.target.style.visibility = 'hidden';
    });
  } else {
    Dibujante.dibujarImagen('imagenes/mapa.png', 0, 5, this.anchoCanvas, this.altoCanvas);
    // Linea Llegada
    Dibujante.dibujarImagen('imagenes/finish1.png', 763, 530, 30, 30);
    Dibujante.dibujarImagen('imagenes/finish2.png', 793, 530, 30, 30);
    Dibujante.dibujarImagen('imagenes/finish1.png', 823, 530, 30, 30);
    Dibujante.dibujarImagen('imagenes/finish2.png', 853, 530, 30, 30);
  }
